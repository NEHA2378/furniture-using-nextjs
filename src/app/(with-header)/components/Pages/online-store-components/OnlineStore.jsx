            ...
            <div className='grid grid-cols-[25%_auto] gap-2'>
                <div lang='p-4 '>
                    <div className='max-h-[450px] overflow-y-scroll overflow-x-hidden  custom-scroll'>
                        ...
                        <div>
                            <h3 className='text-xl pb-3 font-bold'>Tables</h3>
                    ...
                    <div>
                        <h2 className='font-bold text-2xl my-4'>Color</h2>
                        <div>
                            <div className='flex items-center gap-2 pb-3'>
                                <input type='checkbox' />
                                <p>Burnt Amber</p>
                ...
                <div className='p-4'>
                    <div className='border border-gray-400 p-2 flex justify-end gap-3 items-center'>
